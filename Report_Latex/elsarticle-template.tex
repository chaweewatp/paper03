...
\begin{document}
  ...
  \section{Problem formulation}
    ...
    \subsection{The upper and lower bound generation}
      ...
      The interval electricity price forecasting is formulated from two methods; lower and upper quantile regression, and mean and varianece estimation. Are express in Equation~\ref{eq.QR} and~\ref{eq.MV}.
