...
\begin{document}
  ...
  \begin{frontmatter}
    ...
    \begin{abstract}
      ...
      Moreover, increasing in confidence level could generates lower CWC values and represent high reliability's satification.
    \end{abstract}
  ...
  \section{Results}
    ...
    In cleary comarision between MLP and Deep-ResNet models, Fig~\ref{Fig:compare_spike_and_non_spike_model} shows the area covered by upper and lower quantile value, with 5$\%$ confidence level, generated by those models.
    ...
    Futhermore, the proposed Deep ResNet-QR model has capability of interval prediction in task 7, 8, 9 and 10.
    \begin{figure}[H]
      \centering
