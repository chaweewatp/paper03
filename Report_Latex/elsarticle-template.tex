...
\begin{document}
  ...
  \begin{frontmatter}
    ...
    \begin{abstract}
      ...
      A proposed new model was developed from Deep ResNet approach which it capable of spike price and interval price value prediction.
      ...
      Moreover, increasing in confidence level of Deep ResNet models could generates lower CWC values and represent high reliability's satification.
    \end{abstract}
