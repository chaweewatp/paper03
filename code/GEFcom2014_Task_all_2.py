...
# list_task=['Task_9','Task_10','Task_11','Task_12','Task_13','Task_14','Task_15']
list_task=['Task_3','Task_2','Task_3','Task_4','Task_5','Task_6','Task_7','Task_8','Task_9','Task_10','Task_11','Task_12','Task_13','Task_14','Task_15']
# list_model=[3,4,5]
...
for num_task in list(np.arange(0,len(list_task),1)):
    ...
    # model=2
        for method in list_method:
            result=firebase.get('/GEFcom2014/{}/results/model-{}'.format(list_task[num_task],model), '{}'.format(method))
            print(result['PICP'])
            fig, ax = subplots()
