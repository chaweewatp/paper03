...
plt.figure()
plt.plot(list(np.arange(0, 24, 1)), list_upper_01, '-r', alpha=0.8, label='upper')
plt.plot(list(np.arange(0, 24, 1)), list_lower_01, '-r', alpha=0.8, label='lower')
plt.plot(list(np.arange(0, 24, 1)), actual_price, '-b', alpha=0.8, label='actual price')
plt.fill_between(list(np.arange(0, 24, 1)), list_upper_01, list_lower_01, facecolor='magenta', alpha=0.05)
plt.show()
#quantile method
list_upper_02=[]
list_lower_02=[]
