...
list_input=[[0,5,0], [0,20,0], [0,6,1], [0,8,1], [0,10,1], [0,16,1], [0,23,1], [0,7,2],[0,8,2],[0,16,2],[0,17,2],[0,19,2],[0,19,3],[0,23,3]]  #[task, hour, method
...
for item in list_input:
    ...
    if model==2:
        ...
        if item[2]==0:
            ...
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_005/lower_bound'.format(task,model), '{}'.format(hour),list_lower_01[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_005/upper_bound'.format(task,model), '{}'.format(hour),list_upper_01[0])
            ...
            list_upper_01.append(upper[0])
            list_lower_01.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_01/lower_bound'.format(task,model), '{}'.format(hour),list_lower_01[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_01/upper_bound'.format(task,model), '{}'.format(hour),list_upper_01[0])
            ...
            firebase.put('GEFcom2014/{}/results/model-{}/QR_005/lower_bound'.format(task,model), '{}'.format(hour),list_lower_02[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_005/upper_bound'.format(task,model), '{}'.format(hour),list_upper_02[0])
            ...
            list_upper_02.append(upper[0])
            list_lower_02.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_01/lower_bound'.format(task,model), '{}'.format(hour),list_lower_02[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_01/upper_bound'.format(task,model), '{}'.format(hour),list_upper_02[0])
    elif model ==3:
        # item=[2,2]
        hour = item[1]
        ...
        if item[2] == 0:
            ...
            df2 = df2.reset_index(drop=True)
            input1, target1, target2 = get_train_data(df2, df2['Forecasted Total Load'].max(),
                                                      df2['Forecasted Zonal Load'].max(), df2['Zonal Price'].max(), q1,
                                                      q2)
            net = nl.net.newff([[0, 1], [0, 1]], [5, 2])
            err = net.train(input1, target1, epochs=500, show=10, goal=0.01)
            ...
            list_upper_01.append(upper[0])
            list_lower_01.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_005/lower_bound'.format(task, model),
                         '{}'.format(hour), list_lower_01[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_005/upper_bound'.format(task, model),
            ...
            list_upper_01.append(upper[0])
            list_lower_01.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_01/lower_bound'.format(task, model),
                         '{}'.format(hour), list_lower_01[0])
            firebase.put('GEFcom2014/{}/results/model-{}/mean_std_01/upper_bound'.format(task, model),
                         '{}'.format(hour), list_upper_01[0])
            ...
            list_upper_02.append(upper[0])
            list_lower_02.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_005/lower_bound'.format(task, model), '{}'.format(hour),
                         list_lower_02[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_005/upper_bound'.format(task, model), '{}'.format(hour),
                         list_upper_02[0])
            ...
            list_upper_02.append(upper[0])
            list_lower_02.append(lower[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_01/lower_bound'.format(task, model), '{}'.format(hour),
                         list_lower_02[0])
            firebase.put('GEFcom2014/{}/results/model-{}/QR_01/upper_bound'.format(task, model), '{}'.format(hour),
                         list_upper_02[0])
    elif model==4:
        hour = item[1]
